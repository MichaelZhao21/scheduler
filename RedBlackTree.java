public class RedBlackTree extends BinaryTree {
    ...
    public Node searchNode(Process key) {
        Node node = root;
        while (node != null) {
    ...
    public void insertNode(Process key) {
        Node node = root;
        Node parent = null;
    ...
    public Process deleteLeftmost() {
        return deleteNode(null, true);
    }

    public Process deleteNode(Process key, boolean leftmost) {
        Node node = root;

        // If leftmost, traverse down left until no children
